...
export function Environment(name: string): BaseURL {
    return `https://${name}-booking-system-teti.encr.app`
}
...
/**
 * Client is an API client for the booking-system-teti Encore application. 
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        this.headers = {
            ...
            "User-Agent":   "booking-system-teti-Generated-TS-Client (Encore/v1.29.6)",
        }
